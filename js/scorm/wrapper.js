	...
	*/
	...
	ScormWrapper.prototype.initialize = function() {
		...
		if (this.lmsConnected) {
			...
			this.handleError("An error has occurred, the course lost connection to the LMS and your progress will no longer be recorded. Please close this window and relaunch the course from the LMS to reconnect and make sure your progress is saved.");
		}
			...
			if (this.commitRetryPending) {
				...
				if (this.scorm.save()) {
					...
					if (this.commitRetries < this.maxCommitRetries && !this.finishCalled) {
						...
						var _errorMsg = "An error has occurred, the course lost connection to the LMS and your progress will no longer be recorded. Please close this window and relaunch the course from the LMS to reconnect and make sure your progress is saved.";
